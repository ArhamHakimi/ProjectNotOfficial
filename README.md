...
9. Right click on project folder (The cup symbol) and then Run Maven > Other Goals
10. Type in javafx:run into the Goals section and then press Enter or click 'OK'
11. Done
